...
$(BUILD_DIR)/main_tb: $(BUILD_DIR) $(foreach f, graphics_tb.o ui_game.o ui_game_menu.o game.o models.o ai_rand.o menu.o ui_menu.o ui_main.o ui_end_menu.o ui_pause_menu.o stack.o, $(BUILD_DIR)/$f)
	$(CC) $(TERMBOX_FLAG) $(SRC_DIR)/main_tb.c  $(foreach f, graphics_tb.o ui_game.o ui_game_menu.o game.o models.o ai_rand.o menu.o ui_menu.o ui_main.o ui_end_menu.o ui_pause_menu.o stack.o, $(BUILD_DIR)/$f) -o $@

$(BUILD_DIR)/main_minimalist_sdl: $(BUILD_DIR) $(foreach f, graphics_minimalist_sdl.o ui_game.o ui_game_menu.o game.o models.o ai_rand.o menu.o ui_menu.o ui_main.o ui_end_menu.o ui_pause_menu.o stack.o, $(BUILD_DIR)/$f)
	$(CC) $(SDL_FLAG) $(SRC_DIR)/main_minimalist_sdl.c  $(foreach f, graphics_minimalist_sdl.o ui_game.o ui_game_menu.o game.o models.o ai_rand.o menu.o ui_menu.o ui_main.o ui_end_menu.o ui_pause_menu.o stack.o, $(BUILD_DIR)/$f) -o $@
...
$(BUILD_DIR)/stack.o: $(BUILD_DIR)
	$(CC) -c $(SRC_DIR)/stack.c -o $@
