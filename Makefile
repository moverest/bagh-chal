...
all: $(foreach f, test_graphics_tb test_game test_test main_tb test_graphics_minimalist_sdl main_minimalist_sdl test_menu_tb test_menu_graphics_sdl test_neuralnet, $(BUILD_DIR)/$f)
...
$(BUILD_DIR)/test_neuralnet: $(BUILD_DIR) $(foreach f, neuralnet.o test.o, $(BUILD_DIR)/$f)
	$(CC) -o $@ $(SRC_DIR)/test_neuralnet.c $(foreach f, neuralnet.o test.o, $(BUILD_DIR)/$f)
